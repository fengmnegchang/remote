...
public class WelcomeActivityNew extends FragmentActivity  implements OnPageChangeListener,OnClickListener{
...
//	private static final int[] pics = { R.drawable.wel1,  
//         R.drawable.wel2, R.drawable.wel3 };  
...
//        }  
		...
		pagerService = new SelectPagerService(WelcomeActivityNew.this);
